...
function transaction_dml($conn, $fm, $a_src=FALSE)
{
    ...
    $params['td'] = filter_array($a_src, "t_date",date("Y-m-d H:i:s"));//2014-09-01 20:30:57
    $a_ret[DML_RET_DBG] .= sprintf($div_fmt, "t_date", $params['td']);
        ...
        case DML_INS:
            ...
            else
            {
                ...
                $sql = "INSERT INTO m_transaction_types (t_type_name, open_date, "
                        . "parent_type_id, type_sign, user_id) VALUES(:t_name,"
                        . "#NOW#, :t_parent, :t_sign, :t_user)";
            }
            break;
        case DML_UPD:
            $sql = "UPDATE m_transaction_types SET t_type_name=:t_name, ";
        ...
        case DML_INS:
            ...
            else
            {
                $sql = "insert INTO m_loans (place_id, loan_name, start_date, end_date, "
                    ...
                    . "budget_id, loan_sum, open_date) VALUES(:l_place, :l_name, :l_bdate, "
